...
Это empirically первое systematic quantification durability discount в NBA. [TBD: Robst, VanGilder, Coates & Berri (2011)] исследовали performance variability vs salary, но retrospective games_missed как direct predictor не был тестирован в современной CBA-эпохе. Mechanism — рынок воспринимает игроков с длинной injury history как риски для будущего performance reliability; этот воспринимаемый risk премий цены через discount в next contract negotiation.
